    ...
    <div className="page">
        ...
        <div className="wrap">
          <header className="page-head reveal">
            ...
            <p className="lede">
              ...
              the{" "}
              <Link href="/remote-pi/tutorials" className="text-accent underline">
                tutorials
              </Link>
              ; for <strong className="text-fg">why</strong> it works this way,
              see{" "}
              <Link href="/remote-pi/why" className="text-accent underline">
                Why Pi
              </Link>
      ...
      <DocsSection id="what-it-does" title="What it does">
        ...
        <ul className="ml-6 list-disc space-y-2">
          ...
          <li>
            <Link href="/remote-pi/tutorials/mesh-remote" className="text-accent underline">
              Remote mesh
            </Link>{" "}
      ...
      <DocsSection id="commands" title="Command reference">
        ...
        >
          <p className="text-sm">
            ...
            <Link href="/remote-pi/tutorials/daemon" className="text-accent underline">Daemon mode tutorial</Link> for the full how-to.
          </p>
          <DocsTable
            headers={["Command", "Description"]}
            rows={[
        ...
        >
          <p className="text-sm">
            ...
            the{" "}
            <Link href="/remote-pi/tutorials/daemon#cron" className="text-accent underline">
